...
const S = Object.freeze(
  Object.defineProperty({ __proto__: null, loadGmail: d }, Symbol.toStringTag, {
    value: "Module",
  }),
);
function A(e) {
...
function W(e) {
  const t = [
      ...
      { name: "yearLoose", regex: e.compile("_YEAR4_"), handler: V(["year"]) },
      {
        ...
        attempt(e) {
          ...
          for (const i of this.patterns) {
            ...
            if (r) {
              ...
              if (
                ((t = t.slice(0, e.index) + t.slice(e.index + e[0].length + 1)),
                (t = t.trim()),
...
function ae(e) {
  (e.month && e.day && void 0 === e.year && (e.year = new Date().getFullYear()),
...
function Te(e, t) {
  return (null == t ? void 0 : t.filterVisibleElementsOnly) ? e.filter(we) : e;
}
function ve(e) {
  return (
    0 === e.children.length &&
...
function _e(e, t) {
  ...
  return t.rightSibling
    ...
    : t.leftSibling
      ? (console.log("[resolveSingleMatcher] Finding left sibling of element"),
...
function Me(e, t, n) {
  var o, i, r, a;
  if (
    (console.log(`[extractValue] Starting extraction for attribute: ${t.name}`),
    !t)
  )
  ...
  if (
    ...
    if (
      ...
      l &&
        t.transform &&
        (console.log("[extractValue] Applying transform to value - before:", l),
        (l = Se(l, t.transform)),
...
function ke(e, t, n) {
  ...
  for (const i of t.attributes) {
    ...
    t
      ...
      : console.log(`[processParser] No value found for attribute: ${i.name}`);
  }
...
function Oe(e, t) {
  ...
  if (
    (console.log("[findResourceContainers] Initial elements found:", o.length),
    ...
    const e = Te(o, t);
    return (
      console.log("[findResourceContainers] Visible elements found:", e.length),
      e
    );
  }
...
function De(e, t, n, o) {
  ...
  if (
    ...
    (t.contextualButton.injectContainer.rightOfContainer &&
      ...
      console.log("[processContextualButtonParser] Left container found:", a)),
    t.contextualButton.injectContainer.leftOfContainer &&
      ...
      console.log("[processContextualButtonParser] Right container found:", l)),
    !a && !l)
  )
    return (
      console.log(
  ...
  return (
    console.log("[processContextualButtonParser] Returning button config:", s),
    s
  );
}
function Ne(e) {
  ...
  ((n.style.cssText =
    ...
    n.setAttribute("data-notion-button", `${e.resourceType}-${e.resourceId}`));
    ...
    for (const e of a.parser) {
      ...
      if (e.urlFilter) {
        if (e.urlFilter.match && !e.urlFilter.match.some((e) => e.test(t)))
          continue;
        if (e.urlFilter.notMatch && e.urlFilter.notMatch.some((e) => e.test(t)))
          continue;
      }
      const r = Oe(e, {
...
async function He(e, t, n) {
  ...
  return (
    console.log("Scan complete:", a ? "Resources found" : "No resources found"),
            ...
            },
            {
              ...
              transform: {
                fn: (e) => {
                  ...
                  return (null == t ? void 0 : t[1]) || "no-email@outlook.com";
                },
              },
            },
            {
              ...
              transform: {
                fn: (e) => {
                  try {
                    if ((console.log("Parsing date text:", e), !e)) return null;
      ...
      if (r) {
        ...
        if (void 0 !== e.mouseX)
          ((o = window.scrollX + e.mouseX - this.HIGHLIGHT_TOOLTIP_WIDTH / 2),
            console.log("Using mouseX for horizontal positioning:", e.mouseX));
        else {
...
function Et(e) {
  ...
  if (
    ...
    const { keydownListener: t, keyupListenr: n, capture: o } = rt.get(e) || {};
...
const Bt = {
  ...
  turnOnShowAnimation() {
    (console.log("turnOnShowAnimation"), jt({ left: "20px", bottom: "50px" }));
  },
...
async function Jt(e) {
  ...
  const t = { gmail: () => Be(() => Promise.resolve().then(() => S), void 0) },
    n = await t[e]();
              ...
              attributes: [
                {
                  ...
                  transform: { fn: ["ignoreQueryParams", "addTrailingSlash"] },
                },
                {
                  name: "webpageTitle",
...
function vn() {
  return { url: window.location.href, title: document.title, type: "webpage" };
}
async function bn() {
...
async function En() {
  ...
  for (; l < n; ) {
    ...
    const s = wn[window.location.hostname],
      c = Tn[s],
      u = await $e(c, window.location.href, { filterVisibleElementsOnly: !1 });
        ...
        async getIndices(e) {
          ...
          if (o) {
            ...
            try {
              ...
              let i;
              for (qn.lastIndex = 0; null !== (i = qn.exec(o)); ) t.push(i[1]);
            } catch (r) {
...
const Jn = {
  ...
  eo = {
      ...
      if (t.length > 0) {
        ...
        return (
          ...
          t.forEach((t) => {
            ...
            (console.log(`Setting background color to ${i} (isDarkText: ${o})`),
    ...
    getHighlightRange: async () => (await Jt("highlight")).getHighlightRange(),
    closeModal: async () => {

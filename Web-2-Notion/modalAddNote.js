...
box-shadow: 0px 2px 4px -1px rgba(0,0,0,0.2),0px 4px 5px 0px rgba(0,0,0,0.14),0px 1px 10px 0px rgba(0,0,0,0.12);
  ...
  `;
    ...
    <x-div style='font-size:18px; font-family:inherit !important; font-weight:bold; margin-bottom:12px'>Web-2-Notion - New Note</x-div>
    ...
    <x-div style="margin-top:8px;" id="${__saveToNotionIds.statusDiv}"></x-div>
        ...
        if (needAppend) document.documentElement.appendChild(modal);
        //hide on change
        modal.onclick = (event) => {
